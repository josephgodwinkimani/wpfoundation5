...
<form role="search" method="get" class="search-form" action="<?php echo home_url( '/' ); ?>">
	<label>
		<span class="screen-reader-text"><?php echo _x( 'Searching...', 'label', 'jointswp' ) ?></span>
	...
	<input type="submit" class="search-submit button" value="<?php echo esc_attr_x( 'Product Search', 'jointswp' ) ?>" />
</form>